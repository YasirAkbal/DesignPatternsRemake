 ...
 * Örneğin bu alıştırmadaki süper bisiklit builderından sadece vitesi ekleyerek de bir bir bir bisiklet oluşturabiliriz. Bu durum cliente biraz sorumluluk yüklese de büyük esneklik sağlar...
 * Builder kalıbı diğer tüm kalıplarda olduğu gibi farklı şekillerde yorumlanabilir. Bu alıştırmada client'in oluşturma aşamasında gerekli parçaları kendi oluşturduğu ve lazy loading...
 * yapan Builder kalıbı uygulanmıştır.
 */
